...
namespace VhfReceiver.Pages
{
    public partial class TestReceiverPage : ContentPage
    {
        public TestReceiverPage(byte[] bytes)
        {
            ...
            Toolbar.SetData("Receiver Diagnostics", true);
            SetData(bytes);
